...
<![endif]-->
		...
		<script type="text/javascript">
			...
			<script type="text/javascript">
				...
				// });
				$(document).on("click", "#openModalEditCustomer", function () {
					var id_rencana_header = $(this).attr('data-id_rencana_header');
					$("#id_rencana_header").val(id_rencana_header);
					$.ajax({
						url: "<?php echo base_url(); ?>Aproval/get_aproval", 
						async: false,
						type: "POST",    
						data: "id_rencana_header="+id_rencana_header,   
						dataType: "html",
						success: function(data) {
						$('#data_aproval').html(data); 
						$("#ModalAproval").modal('show');
						}
					}) 
				});
				$(document).on("click", "#openModalDetailUrgentPlan", function () {
					var id_rencana_header = $(this).attr('data-id_rencana_header');
					$("#id_rencana_header").val(id_rencana_header);
					$.ajax({
						url: "<?php echo base_url(); ?>Aproval_urgent/get_aproval", 
						async: false,
						type: "POST",    
						data: "id_rencana_header="+id_rencana_header,   
						dataType: "html",
						success: function(data) {
						$('#data_aproval_urgent').html(data); 
						$("#ModalAproval_urgent").modal('show');
						}
					}) 
				});
