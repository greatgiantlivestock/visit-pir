<?php
	...
	$date = date("Ymd");
    $query=mysqli_query($link,"SELECT id_trx_pengobatan,indnr,kode_obat,qty,DATE(tanggal)as tanggal FROM trx_pengobatan tp JOIN trx_rencana_detail trd 
                        ON tp.id_rencana_detail=trd.id_rencana_detail WHERE status_release=0");
